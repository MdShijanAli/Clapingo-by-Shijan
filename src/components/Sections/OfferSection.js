...
const OfferSection = () => {
    return (
        <div className='my-20'>
            ...
            <div className='md:grid md:grid-cols-3 mt-16 w-4/5 mx-auto'>
                <div className='offer1 md:col-span-1 my-5 md:my-0'>
                ...
                <div className='offer2 md:col-span-1 my-5 md:my-0'>
                ...
                <div className='offer3 md:col-span-1 my-5 md:my-0'>
